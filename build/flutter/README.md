...
* `code` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `code` - executable or bundle name on disk.
* `code` - display name shown in window titles and about app dialogs.
